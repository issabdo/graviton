...
#shop
Route::get('shop/getById/{id}/{lang?}', 'ShopApi@getById');
Route::get('shop/delete/{id}', 'ShopApi@delete');
Route::post('shop/add', 'ShopApi@add');
Route::post('shop/update/{id}', 'ShopApi@update');
Route::get('shop/{limit?}/{offset?}/{lang?}', 'ShopApi@index');