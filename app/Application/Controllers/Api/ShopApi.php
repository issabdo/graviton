...
use App\Application\Transformers\ShopTransformers;
...
class ShopApi extends Controller
{
    ...
    public function __construct(Shop $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(ShopTransformers::transform($data))  , 200 );
    }
